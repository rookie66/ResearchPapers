...
<<<<<<< HEAD
global EbNos ofdmCodeNums N LN M x L
=======
...
<<<<<<< HEAD
   ...
   % y_no_papr_reduction_para = reshape(y_no_papr_reduction_serial_noise,LN,ofdmCodeNums);
    y_no_papr_reduction_para = reshape(y_no_papr_reduction_serial,LN,ofdmCodeNums);
=======
    y_no_papr_reduction_serial_noise = awgn(y_no_papr_reduction_serial,EbNo,'measured');
    %串变并S/P
    y_no_papr_reduction_para = reshape(y_no_papr_reduction_serial_noise,LN,ofdmCodeNums);
...
<<<<<<< HEAD
        y_demodulation = 1/L*dFRTPro(y_no_papr_reduction_para,1);%对于矩阵，直接按列dfrft变换
=======
