function [ y_slm_clipping_para,paprs_SLM] = SLMPartProcess( y_para)
...
%                 ofdmClippingPerCode(kkk)
            ...
            len = length(ClippingPerCode);
            theta = -1;
            ClippingPerCode = [ClippingPerCode(1:floor(len/2));theta*ClippingPerCode(1:len-floor(len/2))];
            end
        end
    end
end
