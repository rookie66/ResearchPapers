function [ LFM_Comm ] = LFM_Basic_Func( Phi_m )
%  LFM信号基本的参数设置
...
save('Comm_signal_Func.mat','signal_Num','randnum','randnum_a','signalA','signalB')
...
save('LFM_Basic_Func.mat','t','Fs','Ts','Tp','LFM_Signal','LFM_Comm','N')%将基本参数信息保存到LFM.mat文件中
